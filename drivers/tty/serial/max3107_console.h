...
#ifndef _MAX3107_CONSOLE_H
#define _MAX3107_CONSOLE_H
...
/*
	Calculate MAX3107_BRGxx_xxxxx value:
		...
		#define MAX3107_EXT_xxxxx (DIV << 16 | FRAC)
...
/* Baud rate generator configuration values for external clock 25 MHz */
#define MAX3107_EXT_B300	(0x145800 | 0x05)	/* deviation   0.00% */
#define MAX3107_EXT_B600	(0x0A2C00 | 0x03)	/* deviation  -0.00% */
#define MAX3107_EXT_B1200	(0x051600 | 0x01)	/* deviation   0.00% */
#define MAX3107_EXT_B2400	(0x028B00 | 0x01)	/* deviation  -0.00% */
#define MAX3107_EXT_B4800	(0x014500 | 0x08)	/* deviation   0.01% */
#define MAX3107_EXT_B9600	(0x00A200 | 0x0C)	/* deviation   0.01% */
#define MAX3107_EXT_B19200	(0x005100 | 0x06)	/* deviation   0.01% */
#define MAX3107_EXT_B38400	(0x002800 | 0x0B)	/* deviation   0.01% */
#define MAX3107_EXT_B57600	(0x001B00 | 0x02)	/* deviation   0.01% */
#define MAX3107_EXT_B115200	(0x000D00 | 0x09)	/* deviation   0.01% */
#define MAX3107_EXT_B230400	(0x000600 | 0x0D)	/* deviation  -0.45% */
#define MAX3107_EXT_B460800	(0x000300 | 0x06)	/* deviation   0.47% */
#define MAX3107_EXT_B921600	(0x000100 | 0x0B)	/* deviation   0.47% */

/* Baud rate generator configuration values for internal clock 3.7252 MHz */
#define MAX3107_INT_B300	(0x030800 | 0x01)	/* deviation   0.00% */
#define MAX3107_INT_B600	(0x018400 | 0x01)	/* deviation  -0.01% */
#define MAX3107_INT_B1200	(0x00C200 | 0x00)	/* deviation   0.01% */
#define MAX3107_INT_B2400	(0x006100 | 0x00)	/* deviation   0.01% */
#define MAX3107_INT_B4800	(0x003000 | 0x08)	/* deviation   0.01% */
#define MAX3107_INT_B9600	(0x001800 | 0x04)	/* deviation   0.01% */
#define MAX3107_INT_B19200	(0x000C00 | 0x02)	/* deviation   0.01% */
#define MAX3107_INT_B38400	(0x000600 | 0x01)	/* deviation   0.01% */
#define MAX3107_INT_B57600	(0x000400 | 0x01)	/* deviation  -0.50% */
#define MAX3107_INT_B115200	(0x000200 | 0x00)	/* deviation   1.05% */
#define MAX3107_INT_B230400	(0x000100 | 0x00)	/* deviation   1.05% */
#define MAX3107_INT_B460800	(0x000000 | 0x08)	/* deviation   1.05% */
#define MAX3107_INT_B921600	(0x000000 | 0x04)	/* deviation   1.05% */

/* added in to keep the compiler silent; the corresponding code seems doing nothing to me... */
...
#define WC_TAG			(3 << 14)
#define MAX3107_HIGH_CLK	1

#endif /* _LINUX_SERIAL_MAX3107_CONSOLE_H */
